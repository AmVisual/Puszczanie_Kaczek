...
public class ScorePanel extends JPanel implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("1")) {
			...
			if(returnVal == JFileChooser.APPROVE_OPTION){
				...
				try {
					...
					out.write(Main.stats.getString("Liczba odbic:")+" "+dataPanel.bestThrow[0]+"\n");
					out.write(Main.stats.getString("Odleglosc:")+" "+dataPanel.bestThrow[1]+"\n");
					out.write(Main.stats.getString("Czas lotu:")+" "+dataPanel.bestThrow[2]+"\n");
					out.write(Main.stats.getString("Par")+"\n");
					out.write(Main.stats.getString("Predkość rzutu [m/s]")+": "+dataPanel.bestThrow[3]+"\n");
					out.write(Main.stats.getString("Kat rzutu (do osi OX) [o]")+": "+dataPanel.bestThrow[4]+"\n");
					out.write(Main.stats.getString("Kat kamienia (do osi OX) [o]")+": "+dataPanel.bestThrow[5]+"\n");
					out.write(Main.stats.getString("Masa kamienia [g]")+": "+dataPanel.bestThrow[6]+"\n");
					out.write(Main.stats.getString("Wysokosc rzutu [m]")+": "+dataPanel.bestThrow[7]+"\n");
					out.write(Main.stats.getString("Wspolczynnik oporu powietrza [kg/s]")+": "+dataPanel.bestThrow[8]+"\n");
					out.close();
				} catch (IOException e1) {
					e1.printStackTrace();
				}
		...
		if(e.getActionCommand().equals("2")) {
			...
			if(returnVal == JFileChooser.APPROVE_OPTION){
				...
				try {
					...
					out.write(Main.stats.getString("Stats")+"\n");
					out.write(Main.stats.getString("Liczba odbic:")+" "+dataPanel.lastThrow[0]+"\n");
					out.write(Main.stats.getString("Odleglosc:")+" "+dataPanel.lastThrow[1]+"\n");
					out.write(Main.stats.getString("Czas lotu:")+" "+dataPanel.lastThrow[2]+"\n");
					out.write(Main.stats.getString("Par")+"\n");
					out.write(Main.stats.getString("Predkość rzutu [m/s]")+": "+dataPanel.lastThrow[3]+"\n");
					out.write(Main.stats.getString("Kat rzutu (do osi OX) [o]")+": "+dataPanel.lastThrow[4]+"\n");
					out.write(Main.stats.getString("Kat kamienia (do osi OX) [o]")+": "+dataPanel.lastThrow[5]+"\n");
					out.write(Main.stats.getString("Masa kamienia [g]")+": "+dataPanel.lastThrow[6]+"\n");
					out.write(Main.stats.getString("Wysokosc rzutu [m]")+": "+dataPanel.lastThrow[7]+"\n");
					out.write(Main.stats.getString("Wspolczynnik oporu powietrza [kg/s]")+": "+dataPanel.lastThrow[8]+"\n");
					out.close();
				} catch (IOException e1) {
					e1.printStackTrace();
				}
		...
		if(e.getActionCommand().equals("4")) {
			...
			label2.setText(Main.stats.getString("Liczba odbic:"));
			label3.setText(Main.stats.getString("Odleglosc:"));
			label4.setText(Main.stats.getString("Czas lotu:"));
			label5.setText(Main.stats.getString("Ostatni rzut"));
			label6.setText(Main.stats.getString("Liczba odbic:"));
			label7.setText(Main.stats.getString("Odleglosc:"));
			...
			DataPanel.velocityLabel.setText(Main.stats.getString("Predkosc rzutu [m/s]"));
			DataPanel.throwAngleLabel.setText(Main.stats.getString("Kat rzutu (do osi OX) [o]"));
			DataPanel.stoneAngleLabel.setText(Main.stats.getString("Kat kamienia (do osi OX) [o]"));
			DataPanel.massLabel.setText(Main.stats.getString("Masa kamienia [g]"));
			DataPanel.heightLabel.setText(Main.stats.getString("Wysokosc rzutu [m]"));
			DataPanel.coefficientLabel.setText(Main.stats.getString("Wspolczynnik oporu powietrza [kg/s]"));
			DataPanel.playButton.setText(Main.stats.getString("RZUC!"));
